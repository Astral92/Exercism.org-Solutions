...
def value_of_ace(card_one, card_two):
    ...
    card_value1 = 11 if card_one == 'A' else cards_values[card_one]
    card_value2 = 11 if card_two == 'A' else cards_values[card_two]

    return 11 if card_value1 + card_value2 <= 10 else 1
