...
def new_aliens_collection(alien_start_positions):
    ...
    Args:
        alien_start_postions (list of tuple): list containing (x,y)
 coordinates    

    Returns:
        list: a list of initialized Alien objects
    """
    return [Alien(*coordinates) for coordinates in alien_start_positions]
