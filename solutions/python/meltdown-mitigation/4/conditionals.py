...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature * neutrons_produced_per_second < threshold * 90 /100:
        status_code = "LOW"
    elif temperature * neutrons_produced_per_second <= threshold * (1 + 10/100) and temperature * neutrons_produced_per_second >= threshold * (1 - 10/100):
        status_code = "NORMAL"
    else:
        status_code = "DANGER"
    return status_code 
