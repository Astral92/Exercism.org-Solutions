...
def tag_special_ingredients(dish):
    ...
    return (dish_name, set(ingredients_list) & SPECIAL_INGREDIENTS)
...
def compile_ingredients(dishes):
    ...
    dish_set1, *rest = dishes
    return dish_set1.union(*rest)
...
def singleton_ingredients(dishes, intersection):
    ...
    ingredient_set1, *rest = dishes
    
    return ingredient_set1.union(*rest) ^ intersection
